...
@Описание: Экспортная процедура загрузки контстант
@ПримерИспользования: и заполнить константы

Сценарий: заполнить константы
...
Сценарий: Перезаполнение константы ИспользоватьGCM значением
