...
// создание документа ПТУ
*открытие интерфейса и создание документа ПТУ
...
*Проверка заполнения табличной части
	Тогда Таблица "Товары" содержит строки:
		| 'Артикул' | 'Количество' | 'Товар' | 'Цена'   | 'Сумма'    |
		| 'Т78'     | '15,00'      | 'Торт ' | '150,00' | '1 500,00' |
...
*Проверка создания документа
	И таблица  "Список" содержит строки:
		| 'Номер' |
		| '$Номер$'|
Сценарий: проверка наличия в справочнике номерклатуры Торт		
